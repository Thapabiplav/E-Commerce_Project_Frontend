          ...
          <section className="w-full max-w-xl py-6">
            ...
            <header className="mb-10 text-center">
              ...
              <h2 className="text-sm font-medium text-gray-500 dark:text-gray-400">
                Welcome, please {type === 'register' ?'sign up' :'sign up'} to your dashboard
              </h2>
            </header>
            {/* END Header */}
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="block w-full rounded-lg border border-gray-200 px-5 py-3 leading-6 placeholder-gray-500 focus:border-blue-500 focus:ring focus:ring-blue-500/50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-blue-500" onChange={handleChange}
                    />
                  </div>
                  <div>
                    <div className="mb-5 flex items-center justify-between gap-2">
                      <label className="flex items-center">
                        <input
                          ...
                          id="remember_me"
                          name="remember_me"
                          className="size-4 rounded border border-gray-200 text-blue-500 focus:border-blue-500 focus:ring focus:ring-blue-500/50 dark:border-gray-600 dark:bg-gray-800 dark:ring-offset-gray-900 dark:checked:border-transparent dark:checked:bg-blue-500 dark:focus:border-blue-500" onChange={handleChange}
                        />
